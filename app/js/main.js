...
var Holder = React.createClass({displayName: "Holder",
  render: function(){
      return (React.createElement("div", null, 
      "Holder", 
      React.createElement(Inquiry, null), 
      React.createElement(STT, null), 
...
},{"./Action.js":1,"./Inquiry.js":3,"./STT.js":4,"react":162}],3:[function(require,module,exports){
var React = require('react');


var Inquiry = React.createClass({displayName: "Inquiry",
  render: function(){
    return (React.createElement("div", null, 
      "Inquiry"
...
var STT = React.createClass({displayName: "STT",
  render: function(){
    return (React.createElement("div", null, "STT"));
  }
...
var React = require('react');
var Annyang = require('./speech/events.js');
...
},{"./components/Holder":2,"./speech/events.js":6,"react":162}],6:[function(require,module,exports){
...
'consultar *term': function(term){document.querySelector('div > h2').innerHTML = 'consultar ...' + term},
'transferir' : function(term){document.querySelector('div > h2').innerHTML = 'transferir ...' + term}

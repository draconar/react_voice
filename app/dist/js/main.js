...
var Holder = React.createClass({displayName: "Holder",
  ...
  , render: function(){
      ...
      React.createElement(STT, {synthText: this.state.synthText}), 
      React.createElement(Action, {hearWhatWasSaid: this.hearWhatWasSaid})
    ))
  }
...
},{"../speech/Annyang.js":6,"./Action.js":1,"./Inquiry.js":3,"./STT.js":4,"react":162}],3:[function(require,module,exports){
var React = require('react');
...
var STT = React.createClass({displayName: "STT",
  render: function(){
    return (React.createElement("div", {className: "center-block"}, this.props.synthText));
  }
...
},{"./components/Holder":2,"react":162}],6:[function(require,module,exports){
